...
{
    /**
    Manages a shared pointer to a memory pool. Microsoft SIGMA uses memory pools
    ...
    Microsoft SIGMA provides overloads of the functions that take a MemoryPoolHandle
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline static MemoryPoolHandle Global() noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline static MemoryPoolHandle ThreadLocal() noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline static MemoryPoolHandle New(bool clear_on_destruction = false)
        {
        ...
        */
        SIGMA_NODISCARD inline operator util::MemoryPool &() const
        {
            if (!pool_)
            {
        ...
        */
        SIGMA_NODISCARD inline std::size_t pool_count() const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline std::size_t alloc_byte_count() const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline long use_count() const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline explicit operator bool() const noexcept
        {
    ...
    */
    ...
    the global memory pool. Microsoft SIGMA uses this memory manager profile by default.
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline virtual MemoryPoolHandle get_pool(mm_prof_opt_t) override
        {
    ...
    */
    ...
    public:
        ...
        */
        ...
        SIGMA_NODISCARD static inline MemoryPoolHandle GetPool(mm_prof_opt_t prof_opt, Args &&... args)
        {
            switch (prof_opt)
            {
        ...
        SIGMA_NODISCARD static inline MemoryPoolHandle GetPool()
        {
            return GetPool(mm_prof_opt::mm_default);
        }

    private:
        SIGMA_NODISCARD static inline std::unique_ptr<MMProf> SwitchProfileThreadUnsafe(MMProf *&&mm_prof)
        {
            if (!mm_prof)
            {
        ...
        SIGMA_NODISCARD static inline std::unique_ptr<MMProf> SwitchProfileThreadUnsafe(
        ...
        SIGMA_NODISCARD static inline std::unique_ptr<MMProf> &GetMMProf()
        {
