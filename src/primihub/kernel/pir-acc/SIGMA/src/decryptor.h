...
namespace sigma
{
    ...
    requires a SIGMAContext with valid encryption parameters, and the secret key.
    ...
    */
    ...
    public:
        /**
        Creates a Decryptor instance initialized with the specified SIGMAContext
        and secret key.
        ...
        */
        Decryptor(const SIGMAContext &context, const SecretKey &secret_key);
        ...
        */
        SIGMA_NODISCARD int invariant_noise_budget(const Ciphertext &encrypted);
