...
namespace sigma
{
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline result_type operator()()
        {
        ...
        */
        SIGMA_NODISCARD inline auto generator() const noexcept
        {
            return generator_;
        }
        ...
        */
        SIGMA_NODISCARD inline static constexpr result_type min() noexcept
        {
        ...
        */
        SIGMA_NODISCARD static constexpr result_type max() noexcept
        {
