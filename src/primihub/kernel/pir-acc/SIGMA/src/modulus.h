...
namespace sigma
{
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline int bit_count() const noexcept
        {
            return bit_count_;
        }
        ...
        */
        SIGMA_NODISCARD inline std::size_t uint64_count() const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline const uint64_t *data() const noexcept
        {
            return &value_;
        }
        ...
        */
        SIGMA_NODISCARD inline bool is_zero() const noexcept
        {
            return value_ == 0;
        }
        ...
        */
        SIGMA_NODISCARD inline bool is_prime() const noexcept
        {
            return is_prime_;
        }
        ...
        */
        SIGMA_NODISCARD inline bool operator==(const Modulus &compare) const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline bool operator==(std::uint64_t compare) const noexcept
        {
        ...
        */
            ...
            compr_mode_type compr_mode = Serialization::compr_mode_default) const
        {
            ...
            return util::safe_cast<std::streamoff>(util::add_safe(sizeof(Serialization::SIGMAHeader), members_size));
        }
        ...
        */
        SIGMA_NODISCARD std::uint64_t reduce(std::uint64_t value) const;
    ...
    private:
        ...
        std::uint64_t const_ratio_[3] = { 0, 0, 0 };
    ...
    Microsoft SIGMA when constructing a SIGMAContext object. Normal users should not
    ...
    */
    ...
    and is the default security level enforced by Microsoft SIGMA when constructing
    a SIGMAContext object. Normal users should not have to specify the security
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD static constexpr int MaxBitCount(
            std::size_t poly_modulus_degree, sec_level_type sec_level = sec_level_type::tc128) noexcept
        {
            switch (sec_level)
            {
            case sec_level_type::tc128:
                return util::sigma_he_std_parms_128_tc(poly_modulus_degree);

            case sec_level_type::tc192:
                return util::sigma_he_std_parms_192_tc(poly_modulus_degree);

            case sec_level_type::tc256:
                return util::sigma_he_std_parms_256_tc(poly_modulus_degree);
        ...
        */
        SIGMA_NODISCARD static std::vector<Modulus> BFVDefault(
        ...
        */
        SIGMA_NODISCARD static std::vector<Modulus> Create(std::size_t poly_modulus_degree, std::vector<int> bit_sizes);
        ...
        @throws std::logic_error if not enough suitable primes could be found
        */
        SIGMA_NODISCARD static std::vector<Modulus> Create(
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD static inline Modulus Batching(std::size_t poly_modulus_degree, int bit_size)
        {
        ...
        @throws std::logic_error if not enough suitable primes could be found
        */
        SIGMA_NODISCARD static inline std::vector<Modulus> Batching(
