...
namespace sigma
{
    ...
    of SIGMAContext such that its associated EncryptionParameterQualifiers object has the
    ...
    */
    ...
    public:
        ...
        given through the SIGMAContext object support batching.
        ...
        */
        BatchEncoder(const SIGMAContext &context);
        ...
        */
        SIGMA_NODISCARD inline auto slot_count() const noexcept
        {
            return slots_;
        }
    ...
    private:
        ...
        void populate_roots_of_unity_vector(const SIGMAContext::ContextData &context_data);
