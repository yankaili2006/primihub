...
namespace sigma
{
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline static std::size_t get_index(std::uint32_t galois_elt)
        {
        ...
        @throws std::invalid_argument if galois_elt is not valid
        */
        SIGMA_NODISCARD inline bool has_key(std::uint32_t galois_elt) const
        {
        ...
        */
        SIGMA_NODISCARD inline const auto &key(std::uint32_t galois_elt) const
        {
