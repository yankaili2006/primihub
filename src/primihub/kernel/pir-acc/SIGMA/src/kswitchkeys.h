...
namespace sigma
{
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline auto &data() noexcept
        {
            return keys_;
        }
        ...
        */
        SIGMA_NODISCARD inline auto &data() const noexcept
        {
            return keys_;
        }
        ...
        */
        SIGMA_NODISCARD inline auto &data(std::size_t index)
        {
        ...
        @throws std::invalid_argument if the key at the given index does not exist
        */
        SIGMA_NODISCARD inline const auto &data(std::size_t index) const
        {
            if (index >= keys_.size() || keys_[index].empty())
            {
                throw std::invalid_argument("keyswitching key does not exist");
        ...
        */
        SIGMA_NODISCARD inline auto &parms_id() noexcept
        {
            return parms_id_;
        }
        ...
        @see EncryptionParameters for more information about parms_id.
        */
        SIGMA_NODISCARD inline auto &parms_id() const noexcept
        {
            return parms_id_;
        }
        ...
        */
        ...
        /**
        Loads a KSwitchKeys from an input stream overwriting the current KSwitchKeys.
        The loaded KSwitchKeys is verified to be valid for the given SIGMAContext.
