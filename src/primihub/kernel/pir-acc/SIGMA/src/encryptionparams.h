...
namespace sigma
{
    ...
    */
    ...
    it can be used to create an instance of the SIGMAContext class, which verifies
    ...
    through the SIGMAContext::ContextData class once the SIGMAContext has been created.
    ...
    */
    ...
    public:
        ...
        */
        ...
        is better). In Microsoft SIGMA the degree of the polynomial modulus must be
        ...
        */
        ...
        Microsoft SIGMA each of the prime numbers in the coefficient modulus must
        ...
        */
        inline void set_coeff_modulus(const std::vector<Modulus> &coeff_modulus)
        {
            ...
            else if (coeff_modulus.size() > SIGMA_COEFF_MOD_COUNT_MAX || coeff_modulus.size() < SIGMA_COEFF_MOD_COUNT_MIN)
            {
                throw std::invalid_argument("coeff_modulus is invalid");
            }

            coeff_modulus_ = coeff_modulus;
            device_coeff_modulus_.set_host_data(coeff_modulus.data(), coeff_modulus.size());
        ...
        (bigger is worse). In Microsoft SIGMA the plaintext modulus can be at most
        ...
        */
        ...
        the scheme can perform (bigger is worse). In Microsoft SIGMA the plaintext
        ...
        */
        SIGMA_NODISCARD inline scheme_type scheme() const noexcept
        {
            return scheme_;
        }
        ...
        */
        SIGMA_NODISCARD inline const Modulus &plain_modulus() const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline std::shared_ptr<UniformRandomGeneratorFactory> random_generator() const noexcept
        {
        ...
        */
        SIGMA_NODISCARD inline bool operator==(const EncryptionParameters &other) const noexcept
        {
        ...
        */
        ...
        /**
        Enables access to private members of sigma::EncryptionParameters for SIGMA_C.
        */
    ...
    private:
        ...
        to scheme_type::none.
        */
        SIGMA_NODISCARD bool is_valid_scheme(std::uint8_t scheme) const noexcept
        {
            switch (scheme)
            {
...
{
    template <>
    struct hash<sigma::parms_id_type>
    {
        std::size_t operator()(const sigma::parms_id_type &parms_id) const
        {
    ...
    template <>
    struct hash<sigma::EncryptionParameters>
    {
        std::size_t operator()(const sigma::EncryptionParameters &parms) const
        {
            hash<sigma::parms_id_type> parms_id_hash;
