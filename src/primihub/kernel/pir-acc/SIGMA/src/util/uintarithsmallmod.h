...
namespace sigma
{
    namespace util
    {
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t increment_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
            {
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t decrement_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
            {
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t negate_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
            {
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t div2_uint_mod(std::uint64_t operand, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
            {
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t add_uint_mod(
            std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
            ...
            operand1 += operand2;
            return SIGMA_COND_SELECT(operand1 >= modulus.value(), operand1 - modulus.value(), operand1);
        }
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t sub_uint_mod(
            std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
...
#endif
            unsigned long long temp;
            std::int64_t borrow = static_cast<std::int64_t>(SIGMA_SUB_BORROW_UINT64(operand1, operand2, 0, &temp));
        ...
        */
        ...
        SIGMA_NODISCARD inline std::uint64_t barrett_reduce_128(const T *input, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (!input)
            {
            ...
            return SIGMA_COND_SELECT(tmp3 >= modulus.value(), tmp3 - modulus.value(), tmp3);
        }
        ...
        */
        template <typename T, typename = std::enable_if_t<is_uint64_v<T>>>
        SIGMA_NODISCARD inline std::uint64_t barrett_reduce_64(T input, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
            {
            ...
            // One more subtraction is enough
            return SIGMA_COND_SELECT(tmp[0] >= modulus.value(), tmp[0] - modulus.value(), tmp[0]);
        }
        ...
        */
        SIGMA_NODISCARD inline std::uint64_t multiply_uint_mod(
            std::uint64_t operand1, std::uint64_t operand2, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (modulus.is_zero())
...
/*                if (operand >= modulus.value())
        ...
        */
        ...
        Correctness: modulus should be at most 63-bit, and y must be less than modulus.
        */
        SIGMA_NODISCARD inline std::uint64_t multiply_uint_mod_lazy(
            std::uint64_t x, MultiplyUIntModOperand y, const Modulus &modulus)
        {
#ifdef SIGMA_DEBUG
            if (y.operand >= modulus.value())
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        SIGMA_NODISCARD inline std::uint64_t modulo_uint(
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        SIGMA_NODISCARD std::uint64_t exponentiate_uint_mod(
        ...
        */
        ...
        Correctness: Follows the condition of barrett_reduce_128.
        */
        SIGMA_NODISCARD std::uint64_t dot_product_mod(
