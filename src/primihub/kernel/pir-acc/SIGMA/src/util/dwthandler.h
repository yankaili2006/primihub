...
namespace sigma
{
    namespace util
    {
        ...
        */
        ...
        unroll the loops to create coalesced memory accesses to input and output vectors. In earlier versions of SIGMA,
        ...
        public:
            ...
            */
                ...
                ValueType *values, int log_n, const RootType *roots, const ScalarType *scalar = nullptr) const
            {
                ...
                // variables for indexing
                std::size_t gap = 1;
                std::size_t m = n >> 1;//先右移再赋值 8/2=4 2 1
