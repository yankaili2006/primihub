...
namespace sigma
{
    namespace util
    {
        ...
        public:
            ...
            {
                return reinterpret_cast<const sigma_byte *>(buf_.cbegin());
            }

            SIGMA_NODISCARD inline sigma_byte *data() noexcept
            {
                return reinterpret_cast<sigma_byte *>(buf_.begin());
            }

            SIGMA_NODISCARD inline std::size_t size() noexcept
            {
                return buf_.size();
            }

            SIGMA_NODISCARD inline std::size_t capacity() noexcept
            {
        ...
        public:
            ...
            SIGMA_NODISCARD inline bool at_end() const noexcept
            {
                return head_ == end_;
            }
