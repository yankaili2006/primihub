...
namespace sigma
{
    namespace util
    {
        SIGMA_NODISCARD std::string uint_to_hex_string(const std::uint64_t *value, std::size_t uint64_count);

        SIGMA_NODISCARD std::string uint_to_dec_string(
        ...
        SIGMA_NODISCARD inline auto allocate_uint(std::size_t uint64_count, MemoryPool &pool)
        {
        ...
        SIGMA_NODISCARD inline auto allocate_zero_uint(std::size_t uint64_count, MemoryPool &pool)
        {
        ...
        SIGMA_NODISCARD inline bool is_zero_uint(const std::uint64_t *value, std::size_t uint64_count)
        {
#ifdef SIGMA_DEBUG
            if (!value && uint64_count)
            {
        ...
        SIGMA_NODISCARD inline bool is_equal_uint(
        ...
        SIGMA_NODISCARD inline bool is_high_bit_set_uint(const std::uint64_t *value, std::size_t uint64_count)
        {
#ifdef SIGMA_DEBUG
            if (!value)
            {
...
#pragma clang diagnostic ignored "-Wunused-parameter"
#endif
#endif
        SIGMA_NODISCARD inline bool is_bit_set_uint(
            const std::uint64_t *value, std::size_t uint64_count SIGMA_MAYBE_UNUSED, int bit_index)
        {
#ifdef SIGMA_DEBUG
            if (!value)
            {
        ...
        inline void set_bit_uint(std::uint64_t *value, std::size_t uint64_count SIGMA_MAYBE_UNUSED, int bit_index)
        {
#ifdef SIGMA_DEBUG
            if (!value)
            {
...
#pragma clang diagnostic pop
#endif
#endif
        SIGMA_NODISCARD inline int get_significant_bit_count_uint(const std::uint64_t *value, std::size_t uint64_count)
        {
#ifdef SIGMA_DEBUG
            if (!value && uint64_count)
            {
        ...
        SIGMA_NODISCARD inline std::size_t get_significant_uint64_count_uint(
        ...
        SIGMA_NODISCARD inline std::size_t get_nonzero_uint64_count_uint(
            const std::uint64_t *value, std::size_t uint64_count)
        {
#ifdef SIGMA_DEBUG
            if (!value && uint64_count)
        ...
        */
        SIGMA_NODISCARD inline int get_power_of_two(std::uint64_t value)
        {
        ...
        SIGMA_NODISCARD inline auto duplicate_uint_if_needed(
        ...
        SIGMA_NODISCARD inline int compare_uint(
        ...
        SIGMA_NODISCARD inline bool is_greater_than_uint(
            const std::uint64_t *operand1, const std::uint64_t *operand2, std::size_t uint64_count)
        {
            return compare_uint(operand1, operand2, uint64_count) > 0;
        }

        SIGMA_NODISCARD inline bool is_greater_than_or_equal_uint(
            const std::uint64_t *operand1, const std::uint64_t *operand2, std::size_t uint64_count)
        {
            return compare_uint(operand1, operand2, uint64_count) >= 0;
        }

        SIGMA_NODISCARD inline bool is_less_than_uint(
            const std::uint64_t *operand1, const std::uint64_t *operand2, std::size_t uint64_count)
        {
            return compare_uint(operand1, operand2, uint64_count) < 0;
        }

        SIGMA_NODISCARD inline bool is_less_than_or_equal_uint(
            const std::uint64_t *operand1, const std::uint64_t *operand2, std::size_t uint64_count)
        {
            return compare_uint(operand1, operand2, uint64_count) <= 0;
        }
