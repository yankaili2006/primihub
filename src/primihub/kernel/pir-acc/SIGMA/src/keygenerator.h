...
namespace sigma
{
    ...
    Constructing a KeyGenerator requires only a SIGMAContext.
    ...
    */
    ...
    public:
        /**
        Creates a KeyGenerator initialized with the specified SIGMAContext.

        @param[in] context The SIGMAContext
        @throws std::invalid_argument if the encryption parameters are not valid
        */
        KeyGenerator(const SIGMAContext &context);

        /**
        Creates an KeyGenerator instance initialized with the specified SIGMAContext
        ...
        parameters
        */
        KeyGenerator(const SIGMAContext &context, const SecretKey &secret_key);

        /**
        Returns a const reference to the secret key.
        */
        SIGMA_NODISCARD const SecretKey &secret_key() const;
        ...
        */
        ...
        impact.
        */
        SIGMA_NODISCARD inline Serializable<PublicKey> create_public_key() const
        {
        ...
        */
        ...
        keyswitching
        */
        SIGMA_NODISCARD inline Serializable<RelinKeys> create_relin_keys()
        {
        ...
        */
        ...
        @throws std::invalid_argument if the Galois elements are not valid
        */
        SIGMA_NODISCARD inline Serializable<GaloisKeys> create_galois_keys(const std::vector<std::uint32_t> &galois_elts)
        {
        ...
        */
        ...
        @throws std::invalid_argument if the step counts are not valid
        */
        SIGMA_NODISCARD inline Serializable<GaloisKeys> create_galois_keys(const std::vector<int> &steps)
        {
            if (!context_.key_context_data()->qualifiers().using_batching)
            {
                throw std::logic_error("encryption parameters do not support batching");
        ...
        */
        ...
        keyswitching
        */
        SIGMA_NODISCARD inline Serializable<GaloisKeys> create_galois_keys()
        {
            return create_galois_keys(context_.key_context_data()->galois_tool()->get_elts_all());
        }

        /**
        Enables access to private members of sigma::KeyGenerator for SIGMA_C.
        */
    ...
    private:
        ...
        void compute_secret_key_array(const SIGMAContext::ContextData &context_data, std::size_t max_power);
