...
namespace sigma
{
    ...
    */
    ...
    public:
        ...
        */
        SIGMA_NODISCARD inline pt_coeff_type *data()
        {
            return data_.begin();
        }
        ...
        */
        SIGMA_NODISCARD inline const pt_coeff_type *data() const
        {
            return data_.cbegin();
        }
        ...
        */
        SIGMA_NODISCARD inline gsl::span<pt_coeff_type> data_span()
        {
        ...
        Returns a span pointing to the beginning of the text polynomial.
        */
        SIGMA_NODISCARD inline gsl::span<const pt_coeff_type> data_span() const
        {
        ...
        */
        SIGMA_NODISCARD inline pt_coeff_type *data(std::size_t coeff_index)
        {
            if (!coeff_count_)
            {
                return nullptr;
        ...
        @param[in] coeff_index The index of the coefficient in the plaintext polynomial
        */
        SIGMA_NODISCARD inline const pt_coeff_type *data(std::size_t coeff_index) const
        {
            if (!coeff_count_)
            {
                return nullptr;
        ...
        @throws std::out_of_range if coeff_index is not within [0, coeff_count)
        */
        SIGMA_NODISCARD inline const pt_coeff_type &operator[](std::size_t coeff_index) const
        {
        ...
        @throws std::out_of_range if coeff_index is not within [0, coeff_count)
        */
        SIGMA_NODISCARD inline pt_coeff_type &operator[](std::size_t coeff_index)
        {
            return data_.at(coeff_index);
        }
        ...
        */
        SIGMA_NODISCARD inline bool operator==(const Plaintext &compare) const
        {
        ...
        */
        SIGMA_NODISCARD inline bool is_zero() const
        {
        ...
        */
        SIGMA_NODISCARD inline std::size_t coeff_count() const noexcept
        {
            return coeff_count_;
        }
        ...
        */
        SIGMA_NODISCARD inline std::size_t significant_coeff_count() const
        {
            if (!coeff_count_)
            {
                return 0;
        ...
        */
        SIGMA_NODISCARD inline std::size_t nonzero_coeff_count() const
        {
            if (!coeff_count_)
            {
                return 0;
        ...
        */
        SIGMA_NODISCARD inline std::string to_string() const
        {
            if (is_ntt_form())
            {
        ...
        */
        ...
        /**
        Loads a plaintext from an input stream overwriting the current plaintext.
        The loaded plaintext is verified to be valid for the given SIGMAContext.
