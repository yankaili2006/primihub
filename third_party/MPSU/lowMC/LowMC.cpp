...
void LowMC::instantiate_LowMC() {
    ...
    for (u32 i = 0; i < blocksize; i++) {
        LinMatrices[0].emplace_back((mblock(L_0[i][0]) << 64)
                                    | mblock(L_0[i][1]));
        LinMatrices[1].emplace_back((mblock(L_1[i][0]) << 64)
                                    | mblock(L_1[i][1]));
        LinMatrices[2].emplace_back((mblock(L_2[i][0]) << 64)
                                    | mblock(L_2[i][1]));
        LinMatrices[3].emplace_back((mblock(L_3[i][0]) << 64)
                                    | mblock(L_3[i][1]));
        LinMatrices[4].emplace_back((mblock(L_4[i][0]) << 64)
                                    | mblock(L_4[i][1]));
        LinMatrices[5].emplace_back((mblock(L_5[i][0]) << 64)
                                    | mblock(L_5[i][1]));
        LinMatrices[6].emplace_back((mblock(L_6[i][0]) << 64)
                                    | mblock(L_6[i][1]));
        LinMatrices[7].emplace_back((mblock(L_7[i][0]) << 64)
                                    | mblock(L_7[i][1]));
        LinMatrices[8].emplace_back((mblock(L_8[i][0]) << 64)
                                    | mblock(L_8[i][1]));
        LinMatrices[9].emplace_back((mblock(L_9[i][0]) << 64)
                                    | mblock(L_9[i][1]));
        LinMatrices[10].emplace_back((mblock(L_10[i][0]) << 64)
                                    | mblock(L_10[i][1]));
        LinMatrices[11].emplace_back((mblock(L_11[i][0]) << 64)
                                    | mblock(L_11[i][1]));
        LinMatrices[12].emplace_back((mblock(L_12[i][0]) << 64)
                                    | mblock(L_12[i][1]));
        LinMatrices[13].emplace_back((mblock(L_13[i][0]) << 64)
                                    | mblock(L_13[i][1]));
        LinMatrices[14].emplace_back((mblock(L_14[i][0]) << 64)
                                    | mblock(L_14[i][1]));
        LinMatrices[15].emplace_back((mblock(L_15[i][0]) << 64)
                                    | mblock(L_15[i][1]));
        LinMatrices[16].emplace_back((mblock(L_16[i][0]) << 64)
                                    | mblock(L_16[i][1]));
        LinMatrices[17].emplace_back((mblock(L_17[i][0]) << 64)
                                    | mblock(L_17[i][1]));
        LinMatrices[18].emplace_back((mblock(L_18[i][0]) << 64)
                                    | mblock(L_18[i][1]));
        LinMatrices[19].emplace_back((mblock(L_19[i][0]) << 64)
                                    | mblock(L_19[i][1]));
    }
    ...
    for (u32 i = 0; i < blocksize; i++) {
        KeyMatrices[0].emplace_back((mblock(K_0[i][0]) << 64)
                                    | mblock(K_0[i][1]));
        KeyMatrices[1].emplace_back((mblock(K_1[i][0]) << 64)
                                    | mblock(K_1[i][1]));
        KeyMatrices[2].emplace_back((mblock(K_2[i][0]) << 64)
                                    | mblock(K_2[i][1]));
        KeyMatrices[3].emplace_back((mblock(K_3[i][0]) << 64)
                                    | mblock(K_3[i][1]));
        KeyMatrices[4].emplace_back((mblock(K_4[i][0]) << 64)
                                    | mblock(K_4[i][1]));
        KeyMatrices[5].emplace_back((mblock(K_5[i][0]) << 64)
                                    | mblock(K_5[i][1]));
        KeyMatrices[6].emplace_back((mblock(K_6[i][0]) << 64)
                                    | mblock(K_6[i][1]));
        KeyMatrices[7].emplace_back((mblock(K_7[i][0]) << 64)
                                    | mblock(K_7[i][1]));
        KeyMatrices[8].emplace_back((mblock(K_8[i][0]) << 64)
                                    | mblock(K_8[i][1]));
        KeyMatrices[9].emplace_back((mblock(K_9[i][0]) << 64)
                                    | mblock(K_9[i][1]));
        KeyMatrices[10].emplace_back((mblock(K_10[i][0]) << 64)
                                    | mblock(K_10[i][1]));
        KeyMatrices[11].emplace_back((mblock(K_11[i][0]) << 64)
                                    | mblock(K_11[i][1]));
        KeyMatrices[12].emplace_back((mblock(K_12[i][0]) << 64)
                                    | mblock(K_12[i][1]));
        KeyMatrices[13].emplace_back((mblock(K_13[i][0]) << 64)
                                    | mblock(K_13[i][1]));
        KeyMatrices[14].emplace_back((mblock(K_14[i][0]) << 64)
                                    | mblock(K_14[i][1]));
        KeyMatrices[15].emplace_back((mblock(K_15[i][0]) << 64)
                                    | mblock(K_15[i][1]));
        KeyMatrices[16].emplace_back((mblock(K_16[i][0]) << 64)
                                    | mblock(K_16[i][1]));
        KeyMatrices[17].emplace_back((mblock(K_17[i][0]) << 64)
                                    | mblock(K_17[i][1]));
        KeyMatrices[18].emplace_back((mblock(K_18[i][0]) << 64)
                                    | mblock(K_18[i][1]));
        KeyMatrices[19].emplace_back((mblock(K_19[i][0]) << 64)
                                    | mblock(K_19[i][1]));
        KeyMatrices[20].emplace_back((mblock(K_20[i][0]) << 64)
                                    | mblock(K_20[i][1]));
    }
    return;
}
